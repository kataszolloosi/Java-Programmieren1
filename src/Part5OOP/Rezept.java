...
public class Rezept {
    ...
    public boolean allergisch(String zutat) {
        ...
        //Ein Return muss immer erreicht werden, daher liegt auch eines draussen, denn wenn das true nicht zurueckgebeben wurde
        //dann kommen wir ziemlich sicher hier an und beenden die Funktion/Methode an dieser Stelle - jedes Return schmeisst uns raus aus der Methode!
        return false;
    }

    //pruefen wir hier auf die zwei Worte milch und kaese
